...
class VelocityPublisher(Node):
    ...
    def __init__(self):
        ...
        self.ready_ = 0
        self.distance_ = 0.0
        self.treshold_ = 1.0     #set by programmer

        self.publisher1_ = self.create_publisher(Twist,"/robot1/robot_vel",10)
        self.publisher2_ = self.create_publisher(Twist, "/robot2/robot_vel",10)
            ...
            if(self.counter_ != 11):
                ...
                if(self.robot_ == 2):
                    if(self.distance_ > self.treshold_):
                        ...
                        self.ready_ = 0
                        self.publisher2_.publish(msg)
                        self.get_logger().info('Robot 2 stopped because too close to Turtle 1')
...
def main(args=None):
    ...
    spin_thread.start()
    while rclpy.ok():
        Velocity_Publisher.robot_ = int(input("Choose the robot to control: "))
